...
plotUK <- ggplot() +
  ...
  theme(legend.position = "left",
        ...
        plot.tag.position = c(1.5, 0.5),
        plot.title = element_text(colour = "black", size = 24, hjust = 0, 
                                  vjust = 0, family="Roboto", face="bold"),
        legend.text = element_text(size = 12, colour = "black", family="Roboto", face="bold"),
        legend.title = element_text(size = 12, colour = "black", family="Roboto", face="bold"),
        )
...
ggsave(filename = "2022-06-28_TT.png", plotUK, width = 30, height = 15, unit = "in", bg = "white")
