...
avgMen <- slice_mean(paygapClean, n = 1, diff_mean_hourly_percent) #14.6%
...
plotUK <- ggplot() +
  ...
  geom_point(data = paygapClean,
            ...
            pch = 21) +
  theme_void() +
  labs(title = "The United Kingdom's Gender Pay Gap", tag =str_wrap("With a sample of 2,171 companies having more than 5,000 but less than 20,000 employees, approximately 94% paid men a greater salary than women. On average, these companies paid men 15% more than women. Virgin Atlantic has the greatest pay discrepancy with paying men 66% more than women. Data: gender-pay-gap.service.gov.uk")) +
...
plotUK2 <- ggplot(data = paygapClean, mapping = aes(x = diff_mean_hourly_percent)) +
  stat_slabinterval(slab_fill = "coral", slab_alpha = 1,
...
ggsave(filename = "2022-06-28_TT.png", width = 15, height = 11, unit = "in")
